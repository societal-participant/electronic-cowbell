...
"""
Motion-Activated Electronic Cowbell
...
NOTE ON VOLUME: The WAV is streamed straight from the
filesystem rather than loading it into RAM. If you want
to change the volume, boost the WAV file ITSELF in Audacity,
then re-export and copy it back onto CIRCUITPY as cowbell.wav.
"""
...
MOVEMENT_THRESHOLD_WHILE_PLAYING = 6.0  # stricter threshold used ONLY while
                              ...
                              # retrigger itself in a loop, so raising the bar
                              # here specifically filters
